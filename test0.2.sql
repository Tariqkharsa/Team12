...
CREATE TABLE Departments(
    ...
    PRIMARY KEY(Dep_Num),
    FOREIGN KEY (Dep_Name) REFERENCES MUSEUM(mName)
    );
...
-- ------  FOLLOWING IS TEST CASES      --------
INSERT INTO ARTPIECES(AID, ANAME, ARTIST, DEPTNAME, INDATE, DEPTNAME)
VALUES ('198762','DAVID','MICHEANGELO','SCULPTURE','2022-03-08','FILM');  -- CORRECT RESULT: INSERT SUCCESSFULLY

INSERT INTO ARTPIECES(AID, ANAME, ARTIST, DEPTNAME, INDATE, DEPTNAME)
VALUES ('19876299','DAVID','MICHEANGELO','SCULPTURE','2022-03-08','FILM');  -- CORRECT RESULT: FAIL TO INSERT

INSERT INTO ARTPIECES(AID, ANAME, ARTIST, DEPTNAME, INDATE, DEPTNAME)
VALUES ('198762','DAVID','MICHEANGELO','BOBBY','2022-03-08','FILM');  -- CORRECT RESULT: FAIL TO INSERT

INSERT INTO ARTPIECES(AID, ANAME, ARTIST, DEPTNAME, INDATE, DEPTNAME)
VALUES ('198762','DAVID','MICHEANGELO','SCULPTURE','2022-04-08','FILM');  -- CORRECT RESULT: FAIL TO INSERT

INSERT INTO ARTPIECES(AID, ANAME, ARTIST, DEPTNAME, INDATE, OUTDATE)
VALUES ('198762','DAVID','MICHEANGELO','SCULPTURE','2022-01-08','2022-01-01','FILM');  -- CORRECT RESULT: FAIL TO INSERT

INSERT INTO GiftShop VALUES ('0000054321', '10.25', 'Sold',1);
INSERT INTO GiftShop VALUES ('123456789', '1.99', 'In Stock',2);
INSERT INTO GiftShop VALUES ('987654321', '8.99', 'Sold',3);
INSERT INTO GiftShop VALUES ('165489763', '4', 'Sold',4);
...
VALUES(1,'Summer Art Pieces',10.50,'2022-06-09','2022-07-09');
