...
INSERT INTO TICKET(TID,TTYPES, PRICE, IFSOLD, SOLDDATE)
VALUES ('1234567890','CHILD','12.999', 'N', '2005-09-09');  -- TESTING : CONSTARINT SOLD, CORRECT RESULT: LAST 9 WILL BE TRUNCATED

INSERT INTO TICKET(TID,TTYPES, PRICE, IFSOLD, SOLDDATE)
VALUES ('123456780','CHILD','12.99', 'Y', '2025-09-09');  -- TESTING : CONSTARINT SOLD, CORRECT RESULT: FAIL_TO_INSERT

INSERT INTO TICKET(TID,TTYPES, PRICE, IFSOLD)
VALUES ('123456789099','CHILD','12.99', 'N');  -- TESTING: LENGTH LIMIT OF TID

INSERT INTO TICKET(TID,TTYPES, PRICE, IFSOLD)
VALUES ('ABCD','CHILD','12.99', 'N');  --  TESTING CONSTARINT ONLY NUMBERS
